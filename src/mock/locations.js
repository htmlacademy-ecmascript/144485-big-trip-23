const LOCATIONS = [
  ...
  },
  {
    name: 'Kazan',
    description:
      'Capital of the Republic of Tatarstan, a major port on the left bank of the Volga River at the confluence of the Kazanka River',
    pictures: [
      {
  ...
  },
  {
    name: 'Rome',
    description:
      'The capital and largest city of Italy. It is the administrative center of the Lazio region and the territorial unit of the same name, Rome, equated to a province. It is located on the Tiber River.',
    pictures: [
      {
  ...
  },
  {
    name: 'Male',
    description:
      'The capital of the Republic of Maldives, as well as the largest settlement of the archipelago. It is one of the most densely populated cities in the world.',
    pictures: [
      {
